  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-row gap-3">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-blue-600/10 rounded-xl border border-blue-200/30 backdrop-blur-sm"></div>

          <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-br from-blue-400 to-blue-600 rounded-md shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-all duration-200"></div>

          <div className="relative p-3">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
              <div className="text-xs font-semibold text-blue-600/80 uppercase tracking-wider">Staked</div>
            </div>
            <div className="text-xl font-black text-gray-900 mb-1 font-mono">
              {stakedTokens.toLocaleString()}
            </div>
            <div className="text-xs text-blue-600/70 font-medium">Tokens earning rewards</div>
          </div>
        </motion.div>
